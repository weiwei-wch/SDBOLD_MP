...
%%%%%%%% LOAD YOUR DATA HERE %%%%%%%%
%load('matlab_sd_new.mat');
X0 = [sd_data_z_reg];

%X0 = [surf_1_data_z_reg, surf_2_data_z_reg,surf_3_data_z_reg,...
%    surf_4_data_z_reg,surf_5_data_z_reg,surf_6_data_z_reg,...
%    surf_7_data_z_reg,surf_8_data_z_reg,surf_9_data_z_reg,...
%    surf_10_data_z_reg,surf_11_data_z_reg,surf_12_data_z_reg];

%X0 = [surf_1_data_reg, surf_2_data_reg,surf_3_data_reg,...
%    surf_4_data_reg,surf_5_data_reg,surf_6_data_reg,...
%    surf_7_data_reg,surf_8_data_reg,surf_9_data_reg,...
%    surf_10_data_reg,surf_11_data_reg,surf_12_data_reg];

Y0behav = contrast; % gender - 0=female/1=male
...
input.grouping = ones(498,1);
% --- Names of the groups ---
% here you can specify the names of the groups for the plots
%input.group_names={'HC_female', 'BPD_female', 'MDD_female', 'SCZ_female', 'HC_male', 'BPD_male', 'MDD_male', 'SCZ_male'}; 
input.group_names={'HC', 'BD-M', 'MDD', 'SCZ', 'BD-D'}; 
% --- Names of the behavior data ---
input.behav_names = {'HC > MPD', 'SCZ > affective','BD-M > MDD/BD-D', 'BD-D > MDD'}; 

% --- Names of the imaging data ---
% will only be used if save_opts.img_type='barPlot'
%for ii = 1:72; input.img_names{ii,1} = ['fiber bundle ' num2str(ii)]; end

%clear age diagnosis brain_data brain_data_R gender EDUY fd

%% ---------- Options for PLS ----------

% --- Permutations & Bootstrapping ---
pls_opts.nPerms = 10000;
pls_opts.nBootstraps = 10000;
...
save_opts.output_path = './Cross_diagnostic_results';
...
%save_opts.mask_file = 'final_mask.nii'; % filename of binary mask that will constrain analysis
